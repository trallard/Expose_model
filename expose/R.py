"""Support for building models using R.
"""
...
from expose.interfaces import DatasetLoader
from expose.interfaces import Model
...
class DatasetLoader(DatasetLoader, ObjectMixin):
    """A :class:`~expose.interfaces.DatasetLoader` that calls an R
...
class ClassificationModel(AbstractModel):
    """A :class:`~expose.interfaces.Model` for classification problems
