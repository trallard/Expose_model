""":class:`~expose.interfaces.ModelPersister` implementations.
"""
...
class File(ModelPersister):
    """A :class:`~expose.interfaces.ModelPersister` that pickles models
...
class DatabaseCLOB(Database):
    """A :class:`~expose.interfaces.ModelPersister` derived from
...
class CachedUpdatePersister(ModelPersister):
    """A :class:`~expose.interfaces.ModelPersister` that serves as a
    caching decorator around another `~expose.interfaces.ModelPersister`
    object.
    ...
    value of the underlying :class:`~expose.interfaces.ModelPersister`'s
    ...
    :class:`~expose.interfaces.ModelPersister`'s ``read`` method during
    initialization.
    """
    ...
    def __init__(self,
        ...
        :param dict update_cache_rrule:
          ...
          will be updated.  See :class:`~expose.util.RruleThread` for
          details.
        """
        self.impl = impl
