"""Interfaces defining the behaviour of expose's components.
"""
...
class DatasetLoader(metaclass=DatasetLoaderMeta):
    """A :class:`~expose.interfaces.DatasetLoader` is responsible for
...
class ModelPersister(metaclass=ABCMeta):
    ...
    def upgrade(self, from_version=None, to_version=__version__):
        ...
        Newer versions of expose may require changes to the
        ...
        track of the expose version that was used to create and
