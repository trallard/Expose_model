""":class:`~expose.interfaces.DatasetLoader` implementations.
"""
...
class Table(DatasetLoader):
    """A :class:`~expose.interfaces.DatasetLoader` that uses
    ...
    def __call__(self):
        """See :meth:`expose.interfaces.DatasetLoader.__call__`.
        """
...
class EmptyDatasetLoader(DatasetLoader):
    """This :class:`~expose.interfaces.DatasetLoader` can be used if no
...
class ScheduledDatasetLoader(DatasetLoader):
    """A :class:`~expose.interfaces.DatasetLoader` that loads
    ...
    :class:`~expose.interfaces.DatasetLoader` class that it uses to do
    ...
    def __init__(self,
        ...
        """
        :param expose.interfaces.DatasetLoader impl:
        ...
        :param dict update_cache_rrule:
          ...
          :class:`~expose.util.RruleThread` for details.
        """
        self.impl = impl
